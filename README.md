...
If expenses reach a point where the revenue no longer covers cost over the fixed amount provided by Lazztech LLC, then the **Active Contributors** will be responsible to split the overhead. They may then choose to cease the project and cancel the expenses or continue, at the best interest of the **Active Contributors**.
